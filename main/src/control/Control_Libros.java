...
public class Control_Libros {
    ...
    public void crearLibro(Libro libro, List<Autor> autores) {
        // TODO implement here
        conexion = ConexionBD.connectDatabase();
        String generatedColumns[] = { "idlibro" };
        PreparedStatement ps = null;
    ...
    public List<Libro> mostrarLibros() {
        ...
        String sql = "select idlibro,titulo,valor,ejemplares,edicion,isbn,editorial.nombre AS editorial, libro.ideditorial from libro inner join editorial on libro.ideditorial = editorial.ideditorial;";
        List<String> autores;
